...
contract Upgoaled is Ownable { 
    ...
    function createGoalOwner(string memory _activity, uint _distance, uint _goalPoolId, uint _expiryTimestamp) public onlyOwner {
    ...
    // Pays any users whom have not claimed their rewards and it pays the contract onwer the remaining stake and fees.
